...
public class Login extends JFrame implements ActionListener, LoginData {
    ...
    public Login() {
        ...
        JLabel lblNewLabel_3 = new JLabel("Jose Sequeira  @2023");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        }else if(user.equals(LoginData.user) && pass.equals(password)){
            if (e.getSource()==btnNewButton) {
                JOptionPane.showMessageDialog(null, "Bienvenido");
                PrincipalMonitor principal= new PrincipalMonitor();
